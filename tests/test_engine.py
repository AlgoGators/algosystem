...
class TestEngine:
    ...
    def test_engine_initialization_with_benchmark_dataframe(self, sample_price_series, sample_dataframe):
...
class TestEngineEdgeCases:
    ...
    def test_very_small_price_values(self):
        ...
        small_prices = pd.Series([1e-6, 1.1e-6, 1.2e-6, 1.3e-6, 1.4e-6, 
                                 1.5e-6, 1.6e-6, 1.7e-6, 1.8e-6, 1.9e-6], index=dates)
    ...
    def test_very_large_price_values(self):
        ...
        dates = pd.date_range('2020-01-01', periods=10, freq='D')
        large_prices = pd.Series([1e15, 1.1e15, 1.2e15, 1.3e15, 1.4e15,
                                 1.5e15, 1.6e15, 1.7e15, 1.8e15, 1.9e15], index=dates)
