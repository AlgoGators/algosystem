...
class TestDashboardCommand:
    ...
    def test_standalone_dashboard_command(self, sample_csv_file):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = self.runner.invoke(
                cli, ["dashboard", sample_csv_file, "--output-file", output_file]
            )
...
class TestLaunchCommand:
    ...
    def test_launch_command_with_config(self, mock_start_editor):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = self.runner.invoke(cli, ["launch", "--config", config_path])
...
class TestConfigCommands:
    ...
    def test_create_config_basic(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = self.runner.invoke(cli, ["create-config", config_path])
    ...
    def test_create_config_with_base(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = self.runner.invoke(
                cli, ["create-config", new_config_path, "--based-on", base_path]
            )
    ...
    def test_show_config_existing_file(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = self.runner.invoke(cli, ["show-config", config_path])
    ...
    def test_show_config_nonexistent_file(self):
        ...
        result = self.runner.invoke(cli, ["show-config", "nonexistent_config.json"])
...
class TestCLIIntegration:
    ...
    def test_end_to_end_workflow(self, sample_csv_file):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result1 = self.runner.invoke(cli, ["create-config", config_path])

            # Step 2: Show the config (if creation succeeded)
            if result1.exit_code == 0:
                result2 = self.runner.invoke(cli, ["show-config", config_path])
