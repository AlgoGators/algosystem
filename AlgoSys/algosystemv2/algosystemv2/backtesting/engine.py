...
from algosystemv2.backtesting import metrics
...
class Engine:
    ...
    def generate_dashboard(self, output_path=None, open_browser=True):
        """
        ...
        from algosystemv2.backtesting.dashboard.generator import generate_dashboard

        return generate_dashboard(self, output_path, open_browser)
    ...
    def export_db(self, run_id=None, name="Backtest", description="", hyperparameters=None, include_positions=True, include_pnl=True):
        ...
        from algosystemv2.data.connectors.db_manager import DBManager
